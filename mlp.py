...
def test_mlp(learning_rate=0.0001, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
             dataset='data/audio.pkl.gz', batch_size=20, n_hidden=500):
    """
...
if __name__ == '__main__':
    test_mlp(learning_rate=0.000001, L1_reg=0.00, L2_reg=0.001, n_epochs=1000, batch_size=100, n_hidden=500, dataset='data/audio.pkl.gz')
